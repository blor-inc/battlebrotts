...
| ID | Title | Completed |
|---|---|---|
| B-001 | Push GDD v2 to repo | Sprint 1 |
| B-002 | Eric reviews GDD v2 | Sprint 1 |
| B-003 | Create architecture doc | Sprint 1 (PR #8) |
| B-004 | Set up CI/CD pipeline | Sprint 1 (PR #6, #9) |
| B-005 | Sprint 1 planning | Sprint 1 |
| B-006 | Dashboard rate limit fix | Sprint 4 (PR #14) |
| B-007 | Dashboard XSS hardening | Sprint 5 |
| B-008 | Enable GitHub Pages | Sprint 1 (PR #9) |
